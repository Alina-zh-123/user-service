package com.zhilyuk.userservice.unit;
...
import com.zhilyuk.userservice.service.impl.PaymentCardServiceImpl;
import com.zhilyuk.userservice.service.impl.UserServiceImpl;
...
public class PaymentCardServiceTest {
    ...
    void updatePaymentCard_shouldUpdatePaymentCard() {
        ...
        PaymentCardDto paymentCardDto = paymentCardService.updatePaymentCard(1L, "Marinka", LocalDate.parse("2030-03-30"));
